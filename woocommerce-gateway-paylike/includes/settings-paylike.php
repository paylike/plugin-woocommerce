...
return apply_filters( 'wc_paylike_settings',
    array(
        ...
        'title'           => array(
            ...
            'default'     => __( 'Paylike', 'woocommerce-gateway-paylike' ),
            'desc_tip'    => true,
        ),
        'description'     => array(
            ...
            'default'     => __( 'Note: This gateway processes payments securely via &copy; <a href="https://paylike.io" target="_blank">Paylike</a>. Your card details <strong>never</strong> hit our server.', 'woocommerce-gateway-paylike' ),
            'desc_tip'    => true,
        ),
        'testmode'        => array(
